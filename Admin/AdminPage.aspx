<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="BoysToys.Admin.AdminPage" %>
        ...
        <tr>
            ...
            <td>
                <asp:DropdownList ID="DropDownAddCategory" runat="server"
                    ItemType="BoysToys.Models.Category"
                    SelectMethod="GetCategories" DataTextField="CategoryName"
                    DataValueID="CategoryID">
                </asp:DropdownList>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3"
                    runat="server" Text="* Price required."
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                    ...
                    ControlToValidate="ProductImage" SetFocusOnError="true"
                    Display="Dynamic"></asp:RequiredFieldValidator>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownRemoveProduct" runat="server"
                    ItemType="BoysToys.Models.Product"
