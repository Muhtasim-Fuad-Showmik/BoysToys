...
public class NVPAPICaller
{
    ...
    private string pEndPointURL = "https://api-m.paypal.com";
    private string host = "www.paypal.com";

    // Sandbox strings.
    //private string pEndPointURL_SB = "https://api-3t.sandbox.paypal.com/nvp";
    private string pEndPointURL_SB = "https://api-m.sandbox.paypal.com";
    ...
    public string APIUsername = "sb-kng6e6389119_api1.business.example.com";
    private string APIPassword = "MM7GNF9YU8E94R76";
    private string APISignature = "AIW7kQaTMUjL7-9wAWs.6jJDTa.mAU0ej2KaRd8F-K.7.I325W9ed5Bw";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44371/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44371/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "Boys Toys Sample Application";
        ...
        using (BoysToys.Logic.ShoppingCartActions myCartOrders = new BoysToys.Logic.ShoppingCartActions())
        {
